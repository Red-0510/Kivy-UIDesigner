...
class DrawingSpace(RelativeLayout):
    def __init__(self,**kwargs):
        ...
        self.layout={'Header': {'parent': '', 'type': 'RL', 'arguments': {}, 'size_hint': [0.985, 0.2275], 'pos_hint': {'x': 0.00625, 'y': 0.753}},
                    'Title': {'parent': 'Header', 'type': 'LL', 'arguments': {'markup': 'True', 'font_size': '50sp', 'text': '[b]The Sasti Dukan[/b]'}, 'size_hint': [0.6230964467005076, 0.3142857142857143], 'pos_hint': {'x': 0.19035532994923857, 'y': 0.6476190476190476}},
